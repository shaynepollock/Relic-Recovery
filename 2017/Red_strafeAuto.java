...
public class Red_strafeAuto extends LinearOpMode
    {
    //----------------------------------------------------------------------------------------------
    // State
    //----------------------------------------------------------------------------------------------
    ...
    @Override public void runOpMode() {
        ...
        targetBL_Straight= (positionBL + (int)(COUNTS_PER_INCH *24)*(1));
        targetFL_Straight= (positionFL + (int)(COUNTS_PER_INCH *24)*(1));//bc motors r reversed
        targetFR_Straight= (positionFR + (int)(COUNTS_PER_INCH *24)*(1));
        targetBR_Straight= (positionBR + (int)(COUNTS_PER_INCH *24)*(1));
        ...
        targetBL_R= (backLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *7)*(-1));
        targetFL_R= (frontLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *7)*(1));//bc motors r reversed
        targetFR_R= (frontRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *7)*(-1));
        targetBR_R= (backRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *7)*(1));
        
        targetBL_C= (backLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *15)*(-1));
        targetFL_C= (frontLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *15)*(1));//bc motors r reversed
        targetFR_C= (frontRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *15)*(-1));
        targetBR_C= (backRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *15)*(1));
        
        targetBL_L= (backLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *25)*(-1));
        targetFL_L= (frontLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *25)*(1));//bc motors r reversed
        targetFR_L= (frontRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *25)*(-1));
        targetBR_L= (backRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *25)*(1));
        
        strafe(); 
    
        targetBL_push= (backLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH * 8)*-1);
        targetFL_push= (frontLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *8)*-1);//bc motors r reversed
        targetFR_push= (frontRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *8)*-1);
        targetBR_push= (backRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *8)*-1);
    ...
    topJewel.setPosition(.68); //drop down arm lucas was here btw
    topJewel.setPosition(.5);
...
protected void testJewel() {
   ...
   //else if (hueValue> 150 && hueValue< 200)//if blue
   {
      ...
      sleep(1500);
        ...
        while (! ((( hueValue< 15 || hueValue>320 ) || (hueValue> 150 && hueValue< 250)) || (getRuntime() < 10.0 )))
        {
            for(int i=0; i<3; i++ )
            {
                bottomJewel.setPosition(x);
    ...
    protected void gyro(){
        ...
        // Loop and update the dashboard
            telemetry.update();
            while ((Math.abs (angles.firstAngle)) < 170 && opModeIsActive())
            {
                ...
                telemetry.addData("In", "gyro loop");
            }
