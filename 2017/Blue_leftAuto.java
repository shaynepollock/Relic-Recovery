...
public class Blue_leftAuto extends LinearOpMode
    {
    //----------------------------------------------------------------------------------------------
    // State
    //----------------------------------------------------------------------------------------------
    ...
    @Override public void runOpMode() {
        ...
        targetBL_L= (positionBL + (int)(COUNTS_PER_INCH *25)*(-1));
        targetFL_L= (positionFL + (int)(COUNTS_PER_INCH *25)*(-1));//bc motors r reversed
        targetFR_L= (positionFR + (int)(COUNTS_PER_INCH *25)*(-1));
        targetBR_L= (positionBR + (int)(COUNTS_PER_INCH *25)*(-1));
        ...
        targetBL_R= (positionBL + (int)(COUNTS_PER_INCH *42)*(-1));
        targetFL_R= (positionFL + (int)(COUNTS_PER_INCH *42)*(-1));//bc motors r reversed
        targetFR_R= (positionFR + (int)(COUNTS_PER_INCH *42)*(-1));
        targetBR_R= (positionBR + (int)(COUNTS_PER_INCH *42)*(-1));
        ...
        leftClaw.setPosition(.3); //new positions 1/20
        rightClaw.setPosition(.7);
        // leftClaw.setPosition(.06); //close claw
