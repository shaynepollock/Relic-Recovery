...
public class Red_leftAuto extends LinearOpMode
    {
    //----------------------------------------------------------------------------------------------
    // State
    //----------------------------------------------------------------------------------------------
    ...
    @Override public void runOpMode() {
        ...
        targetBL_R= (positionBL + (int)(COUNTS_PER_INCH *29));
        targetFL_R= (positionFL + (int)(COUNTS_PER_INCH *29));//bc motors r reversed
        targetFR_R= (positionFR + (int)(COUNTS_PER_INCH *29));
        targetBR_R= (positionBR + (int)(COUNTS_PER_INCH *29));
        
        //moves 35 inches, which is about 2.9 ft 
        targetBL_C= (positionBL + (int)(COUNTS_PER_INCH *36));
        targetFL_C= (positionFL + (int)(COUNTS_PER_INCH *36));//bc motors r reversed
        targetFR_C= (positionFR + (int)(COUNTS_PER_INCH *36));
        targetBR_C= (positionBR + (int)(COUNTS_PER_INCH *36));
        
        targetBL_L= (positionBL + (int)(COUNTS_PER_INCH *43));
        targetFL_L= (positionFL + (int)(COUNTS_PER_INCH *43));//bc motors r reversed
        targetFR_L= (positionFR + (int)(COUNTS_PER_INCH *43));
        targetBR_L= (positionBR + (int)(COUNTS_PER_INCH *43));
        ...
        targetBL_push= (backLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH * 10)*-1);
        targetFL_push= (frontLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *10)*-1);//bc motors r reversed
        targetFR_push= (frontRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *10)*-1);
        targetBR_push= (backRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *10)*-1);
        ...
        targetBL_backup=  backLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH * 6);
        targetFL_backup= frontLeft.getCurrentPosition() + (int)(COUNTS_PER_INCH *6);
        targetFR_backup= (frontRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *6));
        targetBR_backup= (backRight.getCurrentPosition() + (int)(COUNTS_PER_INCH *6));
...
//jewel code with change in while loop statement! TEST THIS
